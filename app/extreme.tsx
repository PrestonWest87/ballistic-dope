...
import { calculateExtremeRange, DopePoint } from './ballistics';
        ...
        <View style={styles.section}>
          ...
          {spread !== null && (
            <View style={styles.spreadBadge}>
              <Text style={styles.spreadLabel}>Est. Spread: </Text>
              <Text style={styles.spreadValue}>±{spread.toFixed(1)}"</Text>
            </View>
          )}
